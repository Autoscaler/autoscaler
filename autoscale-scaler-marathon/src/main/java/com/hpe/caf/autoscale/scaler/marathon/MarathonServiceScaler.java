...
public class MarathonServiceScaler implements ServiceScaler
{
            ...
            throws ScalerException
    {
        try {
            ...
            return new InstanceInfo(appGet.getApp().getTasksRunning(), appGet.getApp().getTasksStaged(), appGet.getApp().getInstances(),
                                    hosts, appShutdownPriority, appGet.getApp().getMaxLaunchDelaySeconds());
        } catch (MarathonException e) {
